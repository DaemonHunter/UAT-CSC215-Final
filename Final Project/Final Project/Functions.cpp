...
void Instructions()
{
	cout << "This will be a game of hangman from an earlier assignment with a few additions!" << endl;
	cout <<
		"I will continuously give you words to try to guess. See how many words you can guess before hanging the man!"
		<< endl;
	...
	{
		cout << "If you don't want to play why did you come here?" << endl;
		Sleep(2000);
		exit(0);
	}
	else if (ReadyToPlay == "N")
